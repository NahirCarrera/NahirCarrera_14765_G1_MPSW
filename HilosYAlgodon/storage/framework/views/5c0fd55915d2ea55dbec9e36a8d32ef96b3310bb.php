...
<table class="table">
    <tr>
        ...
        <td>Ingrese el tiempo a invertir:
            <input style="width:200px" placeholder="Meses" class="input" type="number" onChange="datss()" id="dateini" value=""> <input hidden style="width:200px"  class="input" type="date" onChange="datss()" id="datefin"> <input class="input" value="NaN" disabled="true" onChange="datss()" style="width:50px" type="text" id="diasimp">Días</td>
...
<?php echo $__env->make('vista.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USUARIO\Desktop\UNIBLOCK\webpageModificandoVistasDeProductos\resources\views/cotizador/inversiones.blade.php ENDPATH**/ ?>