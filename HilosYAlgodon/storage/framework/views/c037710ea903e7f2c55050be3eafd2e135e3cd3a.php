    ...
    <div class="services-product">
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td><p id="tpa" style="color: #FF0004">Total a pagar:</p></td>
            </tr>
            <tr>
                <td></td>
                <td><input class="down-cv" type="button"  value="Calcular" onClick="generarTabla()" >
                <a href="<?php echo e(route('solicitudCreditos')); ?>">
...
<?php echo $__env->make('vista.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USUARIO\Desktop\UNIBLOCK\webpageModificandoVistasDeProductos\resources\views/cotizador/credito.blade.php ENDPATH**/ ?>