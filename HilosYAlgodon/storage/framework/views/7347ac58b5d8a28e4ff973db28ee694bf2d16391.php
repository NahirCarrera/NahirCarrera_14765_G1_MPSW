                ...
                <div class="row">
                    <div class="input-group">
                        ...
                        <input name="new_requirement_name" type="text" class="form-control"
                            ...
                            value="<?php echo e($requirement->name); ?>">
                    </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USUARIO\Desktop\UNIBLOCK\webpage\resources\views/admin/requirements/requirementData.blade.php ENDPATH**/ ?>