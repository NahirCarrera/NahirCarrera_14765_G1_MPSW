...
?>
    <section>
        ...
        <img src="<?php echo e(url($product->foto)); ?>" class="model transformation" alt="<?php echo e($product->url); ?>">
    </section>
...
<?php echo $__env->make('vista.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USUARIO\Desktop\UNIBLOCK\webpage\resources\views/product/informacion.blade.php ENDPATH**/ ?>