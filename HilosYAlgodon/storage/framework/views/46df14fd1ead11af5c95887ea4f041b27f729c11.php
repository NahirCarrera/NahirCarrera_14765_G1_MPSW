        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-center flex-wrap mt-4">
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="card mx-auto text-bg-primary mb-3 me-4" style="max-width: 18rem; min-width:286px;">
                    ...
                    <!-- Delete Modal -->
                    <div class="modal fade" id="deleteModal<?php echo e($product->id); ?>" data-bs-backdrop="static"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p class="text-danger fw-bold">Se eliminará el producto, todos sus subproductos y
                                        derivados</p>
                                </div>
                        ...
                        <div class="col mx-auto">
                            <div class="card-body p-0">
                                ...
                                <div>
                                    ...
                                    <input name="new_product_levels" type="number" class="form-control"
                                        aria-label="With textarea" min="1" max="3" id="customRange2">
                                </div>
                                <div class="mb-3">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\crist\Desktop\Uni\HostProyectos\PROCESOS\webpageModificandoVistasDeProductos\resources\views/admin/products/products.blade.php ENDPATH**/ ?>