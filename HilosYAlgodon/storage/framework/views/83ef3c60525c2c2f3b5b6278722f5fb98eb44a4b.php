...
<?php echo csrf_field(); ?>
    ...
    <p></p>
    <input hidden type="text" name="title" minlength="10" value="Inversiones">
...
<?php echo $__env->make('vista.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH X:\Project\webpage\resources\views/Formularios/inversiones.blade.php ENDPATH**/ ?>