  ...
  <body>
      <nav>
          <a href="/"><div class="logo"><img src="<?php echo e(url('images/logo.png')); ?>" alt=""></div></a>
          <ul>
              <li>
              ...
              <li><a href="https://www.portalwebcoop.com/servicios-cooperativas/webapp/cruge/ui/login" target="_blank" onclick="window.open(this.href, this.target, 'width=1000,height=1000'); return false;"><button class="down-cv"><i class="lni lni-users"></i></i> Portal Web</button></a></li>
          </ul>
          <div class="toggle">
          </div>
      </nav>
      ...
      <footer>
          ...
          <div class="social-icons">
              ...
              <a href="https://play.google.com/store/apps/details?id=com.webcoopec.banelweb" target="_blank"><i class="lni lni-play-store"></i></a>
          </div>
...
$(document).ready(function() {
  ...
  </html><?php /**PATH C:\Users\USUARIO\Desktop\UNIBLOCK\webpage\resources\views/vista/index.blade.php ENDPATH**/ ?>