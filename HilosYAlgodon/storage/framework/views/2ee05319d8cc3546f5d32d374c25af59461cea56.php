        ...
        <?php $__currentLoopData = $carousel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col" style="max-width: 400px">
                <div class="card cardSliderContainer">
                    <a href="<?php echo e(route('admin.slider.card.show', encrypt($card))); ?>" class="btn btn-outline-dark p-1 m-0">
            ...
            <!-- Modal delete card -->
            <div class="modal fade" id="deleteModal<?php echo e($card->id); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <form action="<?php echo e(route('admin.slider.deleteCard',encrypt($card->id))); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USUARIO\Desktop\UNIBLOCK\webpage\resources\views/admin/slider/sliderManager.blade.php ENDPATH**/ ?>