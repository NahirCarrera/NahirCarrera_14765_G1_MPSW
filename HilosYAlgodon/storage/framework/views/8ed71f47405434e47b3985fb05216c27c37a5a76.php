<?php $__env->startSection('content'); ?>
                ...
                <div class="container-card" id="container-card1"
                    ...
                    <div class="card-blog">
                        ...
                        <div class="card-blog-description">
                            ...
                            <a href="<?php echo e($rapido->url); ?>"><button>Revisar</button></a>
                        </div>
    ...
    <div class="contact-me">
        ...
        <div class="contact-me_image"></div>
    </div>
    <script src="<?php echo e(url('js/coInversiones.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('vista.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\crist\Desktop\Uni\HostProyectos\PROCESOS\webpageModificandoVistasDeProductos\resources\views/welcome.blade.php ENDPATH**/ ?>