...
public class FrmPrincipalMenuBar extends javax.swing.JFrame {
    ...
    private void initPnlStartPage(){
     ...
     private void initPnlHelp(){
        PnlHelp pnlHelp = new PnlHelp();
        pnlHelp.setSize(932,525);
        pnlHelp.setLocation(20,0);
        PnlWindow.removeAll();
        PnlWindow.add(pnlHelp, BorderLayout.CENTER);
        PnlWindow.revalidate();
        PnlWindow.repaint();
    }
    ...
    private void initComponents() {
        ...
        mnuInstruction = new javax.swing.JMenuItem();
        ...
        mnuInstruction.setText("Instructions");
        mnuInstruction.setToolTipText("");
        mnuInstruction.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mnuInstructionActionPerformed(evt);
            }
        });
        MnHelp.add(mnuInstruction);
    ...
    private void mnuInstructionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuInstructionActionPerformed
        initPnlHelp();    
  // TODO add your handling code here:
    }//GEN-LAST:event_mnuInstructionActionPerformed
    ...
    private javax.swing.JMenuItem mnuInstruction;
