    ...
    <div class="modal fade modal-lg" id="newRequirementsModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo e(route('admin.productos.updateProductRequirements', encrypt($subproductDer->id))); ?>"
                        ...
                        <div class="col mx-auto">
                                ...
                                <?php $__currentLoopData = $allRequirements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $requirement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <li class="list-group-item list-group-item-action list-group-item-info">
                                        <input name="requirement_<?php echo e($requirement->id); ?>"
                                            ...
                                            <?php if($currentAssignation): ?> <?php if(in_array($subproductDer->id, $currentAssignation['subproductsDer'])): ?>
                                        checked <?php endif; ?>
                                            <?php endif; ?>>
                            ...
                            <input type="hidden" name="productType" value="subproductDer">
                            <div class="modal-footer">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USUARIO\Desktop\UNIBLOCK\webpageModificandoVistasDeProductos\resources\views/admin/products/subproductDerData.blade.php ENDPATH**/ ?>