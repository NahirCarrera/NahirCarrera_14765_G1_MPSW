...
<div class="contact">
    ...
    <div class="contact-formulario">
        <form method="POST" action="<?php echo e(route('enviarMail')); ?>">
            ...
            <input type="number" name="celular" placeholder="Telefono" required>
...
<?php echo $__env->make('vista.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USUARIO\Desktop\UNIBLOCK\webpageModificandoVistasDeProductos\resources\views/about/contact.blade.php ENDPATH**/ ?>