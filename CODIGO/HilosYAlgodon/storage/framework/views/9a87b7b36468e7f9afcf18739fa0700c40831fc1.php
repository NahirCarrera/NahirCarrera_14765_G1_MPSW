...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    <option <?php if(old('ud_medida') == 'unidad'): ?> selected <?php endif; ?>
                                                        value="unidad">Unidad (unidad)</option>
                                                    <option <?php if(old('ud_medida') == 'm'): ?> selected <?php endif; ?>
                                                        value="m">Metro (m)</option>
                                                    id="ud_medida">
                                                    <option value = "">Elegir...</option>
                                                    <option <?php if($material->ud_medida == 'kg'): ?> selected <?php endif; ?> value="kg">Kilogramo (kg) </option>
                                                    <option <?php if($material->ud_medida == 'm2'): ?> selected <?php endif; ?> value="m2">Metro Cuadrado (m^2) </option>
                                                    <option <?php if(old('ud_medida') == 'unidad'): ?> selected <?php endif; ?> value="unidad">Unidad (unidad)</option>
                                                    <option <?php if(old('ud_medida') == 'm'): ?> selected <?php endif; ?> value="m">Metro (m)</option>
                                                </select>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\crist\Desktop\Uni\HostProyectos\PROCESOS\HilosYAlgodon\resources\views/admin/materiales/materialesManager.blade.php ENDPATH**/ ?>