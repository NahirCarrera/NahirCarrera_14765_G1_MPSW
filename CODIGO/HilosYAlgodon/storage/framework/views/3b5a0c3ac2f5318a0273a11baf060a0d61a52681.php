            ...
            <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px;" id="sidebar">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark text-small shadow" aria-labelledby="dropdownUser1">
                        <li>
                            <a class="dropdown-item" href="<?php echo e(Route('admin.guia', encrypt(Auth::id()))); ?>">Guia de Usuario</a></li>
                        <li>
                        <li><a class="dropdown-item"
                                href="<?php echo e(Route('admin.users.show', encrypt(Auth::id()))); ?>">Perfil</a></li>
                        <li>
...
<script src="<?php echo e(url('js/validations.js')); ?>"></script>
...
<?php /**PATH C:\laragon\www\NahirCarrera_14765_G1_MPSW\CODIGO\HilosYAlgodon\resources\views/admin/layout.blade.php ENDPATH**/ ?>